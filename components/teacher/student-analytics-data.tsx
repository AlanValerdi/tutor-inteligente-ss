              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-lg bg-muted/50 p-3 text-center">
                  ...
                  <p className="font-display text-lg font-bold text-card-foreground">
                    {(anxietyDialogStudent.anxietyMetrics.tabSwitches.reduce((a: number, b: number) => a + b, 0) / 10).toFixed(1)}
                  </p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3 text-center">
                  <p className="text-xs text-muted-foreground">Prom. Clics Consecutivos</p>
                  <p className="font-display text-lg font-bold text-card-foreground">
                    {(anxietyDialogStudent.anxietyMetrics.consecutiveClicks.reduce((a: number, b: number) => a + b, 0) / 10).toFixed(1)}
                  </p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3 text-center">
                  <p className="text-xs text-muted-foreground">Prom. Clics Fallidos</p>
                  <p className="font-display text-lg font-bold text-card-foreground">
                    {(anxietyDialogStudent.anxietyMetrics.missedClicks.reduce((a: number, b: number) => a + b, 0) / 10).toFixed(1)}
                  </p>
                </div>
              </div>
